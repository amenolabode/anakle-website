  ...
  return (
    <>
      <div className="footprint-container">
        <div className="footprint-container-wrapper container">
              ...
              <div className="footprint-text">
                <div className="footprint-header">
                  ...
                  <p className="footprint-subtitle-text">
                    We’ve represented companies from Financial services to Telecoms to
                    FMCG. Our stakeholders
                    trust us to bring their stories to life through ad
                    campaigns, TV shows, and internationally broadcast films.
                  </p>
                </div>
              </div>
          ...
          <div className="footprint-col footprint-logos-container">
            <div className="footprint-logos-wrapper">
              <div className="logos">
                <img
                  className="footprint-logos"
                  src="./british_council-1.png"
                  alt="yaaay"
                />
                <img
                  className="footprint-logos"
